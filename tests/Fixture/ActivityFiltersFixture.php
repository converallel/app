...
class ActivityFiltersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_filter_date_type_idx' => ['type' => 'index', 'columns' => ['date_type_id'], 'length' => []],
            'fk_filter_location_id_idx' => ['type' => 'index', 'columns' => ['location_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['user_id'], 'length' => []],
            'fk_filter_date_type_id' => ['type' => 'foreign', 'columns' => ['date_type_id'], 'references' => ['filter_date_types', 'id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
            'fk_filter_location_id' => ['type' => 'foreign', 'columns' => ['location_id'], 'references' => ['locations', 'id'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
            'fk_filter_user_id' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
